...
WEEK_STRINGS = [
     ...
     '10/07']
WEEK_DICT = {
                WEEKS[i]: WEEK_STRINGS[i] for i in range(23)
            }
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            id="header",
            children=[
                html.H4(children="Relationship between COVID-19 stages and mental health outcomes in 2020"),
                html.P(
                    id="description",
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Slider(
                                            ...
                                            marks={
                                                str(week): {
                                                    "label": WEEK_DICT[week],
                                                    "style": {"color": "#7fafdf"},# if (week != 25 and week != 35 and week != 33) else '#2f2f2f' },
                                                }
                                                for week in WEEKS
                                            },
                                        ),
...
def display_map(week):
    if (week == 25 or week == 35 or week == 33): # weeks without enough responses
        img = Image.open(os.path.join(
                    APP_PATH, os.path.join("assets", "plotna.png")
                ))
